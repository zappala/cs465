...
static = '/static/lectures/f22/'
pubs = '/static/pubs/'
term = '/fall-2022/'

@app.route('/fall-2022/lectures')
def fall2022lectures():
    lecs = os.listdir(static[1:])
    return render_template(term + 'lectures.html', files=lecs, base=static )


@app.route('/fall-2022/schedule')
def fall2022schedule():
    s = Schedule()
    ...
    d = s.day("Oct 13")
    d.lecture("Test will be live  Oct 14 through Oct 16 on LearningSuite")
    ...
    d = s.day("Nov 10")
    d.lecture("Buffer Overflow wrapup, Start Secure Email")
    ...
    d = s.day("Nov 17")
    d.lecture("Midterm Exam 2 Live on LearningSuite Nov 17 through Nov 19")
    ...
    return render_template('fall-2022/schedule.html',active='schedule', weeks=s.weeks)
