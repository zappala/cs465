...
static = '/static/lectures/f21/'
pubs = '/static/pubs/'
term = '/fall-2021/'

@app.route('/fall-2021/lectures')
def fall2021lectures():
    lecs = os.listdir(static[1:])
    return render_template(term + 'lectures.html', files=lecs, base=static )


@app.route('/fall-2021/schedule')
def fall2021schedule():
    s = Schedule()
    ...
    d = s.day("Oct 7 - ONLINE CLASS TODAY")
    ...
    d = s.day("Nov 18")
    d.lecture("Midterm Exam 2 Live on LearningSuite Nov 18 through Nov 20")
    ...
    return render_template('fall-2021/schedule.html',active='schedule', weeks=s.weeks)
